...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *PreviewAspNetCoreWebAPI*):

Restore dependencies
```
    cd "PreviewAspNetCoreWebAPI"
    dotnet restore
```

Execute unit tests
```
    cd "PreviewAspNetCoreWebAPI/test/PreviewAspNetCoreWebAPI.Tests"
    dotnet test
```

Deploy application
```
    cd "PreviewAspNetCoreWebAPI/src/PreviewAspNetCoreWebAPI"
